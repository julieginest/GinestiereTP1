public class Company{
    ...
    private static void L() {
        ...
        {
            Console.WriteLine("Séléctioner une entreprise entre 1 et " + Program.CompaniesList.Count);
            Console.Clear();
            ...
            if(No < 1 || No > Program.CompaniesList.Count){
                E4:
                Console.Clear();
                Console.WriteLine("1 - Gérer les contacts");
                Console.WriteLine("2 - Gérer l'emplacement");
                Console.WriteLine("3 - Gérer l'entreprise");
                select = Console.ReadKey(true).KeyChar;
